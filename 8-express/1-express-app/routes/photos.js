...
// as we are dealing with file uploads, it would be awesome to do some
// uploads to S3 as well :P
...
exports.list = function (req, res, next) {
    ...
    // in mongodb a query targets a specific collection of documents via
    // some criteria specification/conditions. It may include a
    // projection the specifies the fields from the matching documents
    // to return. We may also modify the query generated by imposing
    // limits, skips and orders.
...
exports.download = function (dir) {
    return function (req, res, next) {
        ...
        Photo.findById(id, function (err, photo) {
            ...
            // sendfile method is provided to res by the
            // `express.static()` middleware. This will transfer the
            // file, i.e, the data will be transfered and then
